    ...
    <div class="container">
        <form action="#" class="form">
            ...
            <div class="form-bottom">
                ...
                <span class="form-bottom__second">Посмотреть мой образец</span>
                <span class="form-bottom__second">документа об обучении</span>
                <span class="form-bottom__date">сегодня 25.04.2019</span>
            </div>
        </form>
        <div class="form-descr">
            Нажмите на кнопку «Начать обучение бесплатно» и вы сразу получите
            доступ к демонстрационном курсу обучения
        </div>
    </div>
</section>