<section class="course-program">
    ...
    <div class="course-program__blocks">
        <div class="course-program__block">
            <div class="course-program__block-img">
        ...
        <div class="course-program__block">
            ...
            <div class="course-program__block-descr">
                <div class="course-program__block-descr__part">Часть 6</div>
                <div class="course-program__block-descr__title">Основы управления человеческими ресурсами</div>
                <div class="course-program__block-descr__more">Подробнее</div>
            </div>
        </div>
        ...
        <div class="course-program__block">
            ...
            <div class="course-program__block-descr">
                <div class="course-program__block-descr__part">Часть 7</div>
                <div class="course-program__block-descr__title">Основы управления человеческими ресурсами</div>
                <div class="course-program__block-descr__more">Подробнее</div>
            </div>
        </div>
        ...
        <div class="course-program__block">
            ...
            <div class="course-program__block-descr">
                <div class="course-program__block-descr__part">Часть 9</div>
                <div class="course-program__block-descr__title">Основы управления человеческими ресурсами</div>
                <div class="course-program__block-descr__more">Подробнее</div>
            </div>
        </div>
